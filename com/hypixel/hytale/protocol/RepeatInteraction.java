...
public class RepeatInteraction extends SimpleInteraction {
   ...
   public static RepeatInteraction toObject(MemorySegment mem, int offset) {
      if (offset + 47 > mem.byteSize()) {
         ...
         int[] tags = null;
         if (hasTags(mem, offset)) {
            int offx = offset + getValidatedOffset(mem, offset, 39, 47, "Tags");
   ...
   public int serialize(@Nonnull MemorySegment mem, int offset) {
      ...
      mem.set(PacketIO.PROTO_INT, (long)(offset + 19), this.forkInteractions);
      mem.set(PacketIO.PROTO_INT, (long)(offset + 23), this.repeat);
