...
public class InventoryActiveSlotRequestEvent extends CancellableEcsEvent {
   private final int previousSlot;
   private final int inventorySectionId;
   private byte newSlot;
   private final boolean serverRequest;

   public InventoryActiveSlotRequestEvent(int inventorySectionId, int previousSlot, byte newSlot, boolean serverRequest) {
