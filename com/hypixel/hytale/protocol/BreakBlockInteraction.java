...
public class BreakBlockInteraction extends SimpleBlockInteraction {
   ...
   public static BreakBlockInteraction toObject(MemorySegment mem, int offset) {
      if (offset + 41 > mem.byteSize()) {
         ...
         int[] tags = null;
         if (hasTags(mem, offset)) {
            int offx = offset + getValidatedOffset(mem, offset, 33, 41, "Tags");
   ...
   public int serialize(@Nonnull MemorySegment mem, int offset) {
      ...
      if (this.effects != null) {
         mem.set(PacketIO.PROTO_INT, (long)(offset + 21), varOffset - offset - 41);
      ...
      if (this.settings != null) {
         mem.set(PacketIO.PROTO_INT, (long)(offset + 25), varOffset - offset - 41);
         if (this.settings.size() > 4096000) {
            throw ProtocolException.dictionaryTooLarge("Settings", this.settings.size(), 4096000);
         }
