...
public class HorizontalSelector extends SelectorType {
   ...
   private class RuntimeSelector implements Selector {
      ...
      @Nonnull
      protected FrustumProjectionProvider projectionProvider;
      @Nonnull
      ...
      private RuntimeSelector() {
         Objects.requireNonNull(HorizontalSelector.this);
         super();
         this.executor = new HitDetectionExecutor();
         this.modelMatrix = new Matrix4d();
         this.projectionProvider = new FrustumProjectionProvider();
