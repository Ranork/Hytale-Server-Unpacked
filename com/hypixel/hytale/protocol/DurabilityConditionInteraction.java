...
public class DurabilityConditionInteraction extends SimpleInteraction {
   ...
   public static ValueType getValueType(MemorySegment mem, int offset) {
      return ValueType.fromValue(mem.get(PacketIO.PROTO_BYTE, (long)(offset + 23)));
   }
   ...
   public static DurabilityOperator getOperator(MemorySegment mem, int offset) {
      return DurabilityOperator.fromValue(mem.get(PacketIO.PROTO_BYTE, (long)(offset + 24)));
   }
   ...
   public static DurabilityConditionInteraction toObject(MemorySegment mem, int offset) {
      if (offset + 45 > mem.byteSize()) {
         ...
         int[] tags = null;
         if (hasTags(mem, offset)) {
            int offx = offset + getValidatedOffset(mem, offset, 37, 45, "Tags");
         ...
         return new DurabilityConditionInteraction(
            ...
            ValueType.fromValue(mem.get(PacketIO.PROTO_BYTE, (long)(offset + 23))),
            DurabilityOperator.fromValue(mem.get(PacketIO.PROTO_BYTE, (long)(offset + 24)))
         );
      }
   }
   ...
   public int serialize(@Nonnull MemorySegment mem, int offset) {
      ...
      mem.set(PacketIO.PROTO_FLOAT, (long)(offset + 19), this.threshold);
      mem.set(PacketIO.PROTO_BYTE, (long)(offset + 23), (byte)this.valueType.getValue());
      mem.set(PacketIO.PROTO_BYTE, (long)(offset + 24), (byte)this.operator.getValue());
