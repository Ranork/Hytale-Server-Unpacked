...
public class ClientEffectWorldSettings {
    public static BuilderCodec<ClientEffectWorldSettings> CODEC = ((Builder)((Builder)((Builder)((Builder)((Builder)((Builder)((Builder)BuilderCodec.builder(
                                        ClientEffectWorldSettings.class, ClientEffectWorldSettings::new
                                    )
                                    .append(
                                        new KeyedCodec("SunHeightPercent", Codec.FLOAT),
                                        (settings, o) -> settings.sunHeightPercent = o,
                                        settings -> settings.sunHeightPercent
                                    )
                                    .add())
                                .append(
                                    new KeyedCodec("SunAngleDegrees", Codec.FLOAT),
                                    (settings, o) -> settings.sunAngleRadians = (float)Math.toRadians((double)o.floatValue()),
                                    settings -> (float)Math.toDegrees((double)settings.sunAngleRadians)
                                )
                                .add())
                ...
                .add())
            .append(
                new KeyedCodec("SunshaftScaleFactor", Codec.FLOAT), (settings, o) -> settings.sunshaftScaleFactor = o, settings -> settings.sunshaftScaleFactor
            )
            .add())
        .build();
