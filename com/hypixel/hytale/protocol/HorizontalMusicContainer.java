...
public class HorizontalMusicContainer extends MusicContainer {
   ...
   public static HorizontalMusicContainer deserialize(@Nonnull ByteBuf buf, int offset) {
      if (buf.readableBytes() - offset < 80) {
         ...
         if ((nullBits & 32) != 0) {
            ...
            int varIntLenx = VarInt.size(childrenCount);
            if (childrenCount > 4096000) {
               throw ProtocolException.arrayTooLong("Children", childrenCount, 4096000);
            }

            if (varPos2 + varIntLenx + childrenCount * 4L > buf.readableBytes()) {
               throw ProtocolException.bufferTooSmall("Children", varPos2 + varIntLenx + childrenCount * 4, buf.readableBytes());
            }

            obj.children = new int[childrenCount];

            for (int i = 0; i < childrenCount; i++) {
               obj.children[i] = buf.getIntLE(varPos2 + varIntLenx + i * 4);
            }
         }
   ...
   public static MusicTransitionType getTransitionType(MemorySegment mem, int offset) {
      return MusicTransitionType.fromValue(mem.get(PacketIO.PROTO_BYTE, (long)(offset + 37)));
   }
   ...
   public static boolean getPlayToCompletion(MemorySegment mem, int offset) {
      return mem.get(PacketIO.PROTO_BOOL, (long)(offset + 42));
   }
   ...
   public static float getResumeMemoryDuration(MemorySegment mem, int offset) {
      return mem.get(PacketIO.PROTO_FLOAT, (long)(offset + 43));
   }
   ...
   public static MusicTransitionType getDefaultPhaseTransitionType(MemorySegment mem, int offset) {
      return MusicTransitionType.fromValue(mem.get(PacketIO.PROTO_BYTE, (long)(offset + 63)));
   }
   ...
   public static float getDefaultPhaseTransitionDuration(MemorySegment mem, int offset) {
      return mem.get(PacketIO.PROTO_FLOAT, (long)(offset + 64));
   }
   ...
   public static HorizontalMusicContainer toObject(MemorySegment mem, int offset) {
      if (offset + 80 > mem.byteSize()) {
         ...
         int[] children = null;
         if (hasChildren(mem, offset)) {
            int offx = offset + getValidatedOffset(mem, offset, 76, 80, "Children");
            long packedx = VarInt.getWithLength(mem, offx);
            int lenx = (int)packedx;
            if (lenx < 0) {
               throw ProtocolException.negativeLength("Children", lenx);
            }

            if (lenx > 4096000) {
               throw ProtocolException.arrayTooLong("Children", lenx, 4096000);
            }

            int lenOffset = (int)(packedx >>> 32);
            if (offx + lenOffset + lenx * 4L > mem.byteSize()) {
               throw ProtocolException.bufferTooSmall("Children", offx + lenOffset + lenx * 4, (int)mem.byteSize());
            }

            offx += lenOffset;
            children = new int[lenx];
            MemorySegment.copy(mem, PacketIO.PROTO_INT, offx, children, 0, lenx);
         }
         ...
         return new HorizontalMusicContainer(
            ...
            MusicTransitionType.fromValue(mem.get(PacketIO.PROTO_BYTE, (long)(offset + 37))),
            mem.get(PacketIO.PROTO_FLOAT, (long)(offset + 38)),
            mem.get(PacketIO.PROTO_BOOL, (long)(offset + 42)),
            mem.get(PacketIO.PROTO_FLOAT, (long)(offset + 43)),
            hasNameTranslationKey(mem, offset)
               ? PacketIO.readVarString(
                  "NameTranslationKey", mem, offset + getValidatedOffset(mem, offset, 68, 80, "NameTranslationKey"), 4096000, PacketIO.UTF8
               )
               : null,
            mem.get(PacketIO.PROTO_INT, (long)(offset + 47)),
            hasTempo(mem, offset) ? TempoSettings.toObject(mem, offset + 51) : null,
            stateBindings,
            MusicTransitionType.fromValue(mem.get(PacketIO.PROTO_BYTE, (long)(offset + 63))),
            mem.get(PacketIO.PROTO_FLOAT, (long)(offset + 64)),
            children
         );
      }
   }
   ...
   public int serialize(@Nonnull MemorySegment mem, int offset) {
      ...
      mem.set(PacketIO.PROTO_FLOAT, (long)(offset + 1), this.volume);
      mem.set(PacketIO.PROTO_INT, (long)(offset + 5), this.loopCount);
      mem.set(PacketIO.PROTO_FLOAT, (long)(offset + 9), this.weight);
      if (this.silenceAfter != null) {
      ...
      mem.set(PacketIO.PROTO_FLOAT, (long)(offset + 29), this.fadeInDuration);
      mem.set(PacketIO.PROTO_FLOAT, (long)(offset + 33), this.fadeOutDuration);
      mem.set(PacketIO.PROTO_BYTE, (long)(offset + 37), (byte)this.transitionType.getValue());
      mem.set(PacketIO.PROTO_FLOAT, (long)(offset + 38), this.transitionDuration);
      mem.set(PacketIO.PROTO_BOOL, offset + 42, this.playToCompletion);
      mem.set(PacketIO.PROTO_FLOAT, (long)(offset + 43), this.resumeMemoryDuration);
      mem.set(PacketIO.PROTO_INT, (long)(offset + 47), this.audioCategoryIndex);
      if (this.tempo != null) {
      ...
      mem.set(PacketIO.PROTO_BYTE, (long)(offset + 63), (byte)this.defaultPhaseTransitionType.getValue());
      mem.set(PacketIO.PROTO_FLOAT, (long)(offset + 64), this.defaultPhaseTransitionDuration);
      int varOffset = offset + 80;
      if (this.nameTranslationKey != null) {
         mem.set(PacketIO.PROTO_INT, (long)(offset + 68), varOffset - offset - 80);
         varOffset += PacketIO.writeVarString(mem, varOffset, this.nameTranslationKey, 4096000);
      } else {
         mem.set(PacketIO.PROTO_INT, (long)(offset + 68), -1);
      }

      if (this.stateBindings != null) {
         mem.set(PacketIO.PROTO_INT, (long)(offset + 72), varOffset - offset - 80);
         if (this.stateBindings.length > 4096000) {
            throw ProtocolException.arrayTooLong("StateBindings", this.stateBindings.length, 4096000);
         }
         ...
         mem.set(PacketIO.PROTO_INT, (long)(offset + 72), -1);
      }

      if (this.children != null) {
         mem.set(PacketIO.PROTO_INT, (long)(offset + 76), varOffset - offset - 80);
         if (this.children.length > 4096000) {
            throw ProtocolException.arrayTooLong("Children", this.children.length, 4096000);
         }
         ...
         mem.set(PacketIO.PROTO_INT, (long)(offset + 76), -1);
      }
         ...
         if (v >= 3) {
            ...
            if (v >= 3) {
               ...
               if ((nullBits & 16) != 0) {
                  ...
                  int posx = offset + 80 + v;
                  int stateBindingsCount = VarInt.peek(buffer, posx);
                  if (stateBindingsCount < 0) {
                  ...
                  posx += VarInt.size(stateBindingsCount);

                  for (int i = 0; i < stateBindingsCount; i++) {
                     ValidationResult structResult = StateBinding.validateStructure(buffer, posx);
                     if (!structResult.isValid()) {
                        return ValidationResult.error("Invalid StateBinding in StateBindings[" + i + "]: " + structResult.error());
                     }

                     posx += StateBinding.computeBytesConsumed(buffer, posx);
                  }
               }
      ...
      if (this == obj) {
         ...
         return !(obj instanceof HorizontalMusicContainer other)
            ...
            : this.volume == other.volume
               ...
               && Arrays.equals((Object[])this.stateBindings, (Object[])other.stateBindings)
   ...
   public int hashCode() {
      ...
      result = 31 * result + Arrays.hashCode((Object[])this.stateBindings);
