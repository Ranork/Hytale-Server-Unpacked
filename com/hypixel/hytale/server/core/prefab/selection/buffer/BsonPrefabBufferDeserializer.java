         ...
         if (blocksValue != null) {
            ...
            for (BsonValue blockValue : blocksValue.asArray()) {
               ...
               try {
                  ...
                  throw new IllegalStateException("Failed to load block type for " + path + " at " + realX + ", " + realY + ", " + realZ, var30);
               }
      ...
      if (entitiesValue == null) {
         ...
         for (int size = entitiesArray.size(); i < size; i++) {
            ...
            try {
               ...
               throw new IllegalStateException("Failed to load entity wrapper #" + i + ": " + entityDocument, var15);
            }
         }
