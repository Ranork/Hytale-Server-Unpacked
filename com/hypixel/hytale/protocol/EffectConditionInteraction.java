...
public class EffectConditionInteraction extends SimpleInteraction {
   ...
   public static EffectConditionInteraction deserialize(@Nonnull ByteBuf buf, int offset) {
      if (buf.readableBytes() - offset < 45) {
         ...
         if ((nullBits & 32) != 0) {
            ...
            int varIntLenx = VarInt.size(entityEffectsCount);
            if (entityEffectsCount > 4096000) {
               throw ProtocolException.arrayTooLong("EntityEffects", entityEffectsCount, 4096000);
            }

            if (varPos5 + varIntLenx + entityEffectsCount * 4L > buf.readableBytes()) {
               throw ProtocolException.bufferTooSmall("EntityEffects", varPos5 + varIntLenx + entityEffectsCount * 4, buf.readableBytes());
            }

            obj.entityEffects = new int[entityEffectsCount];

            for (int ix = 0; ix < entityEffectsCount; ix++) {
               obj.entityEffects[ix] = buf.getIntLE(varPos5 + varIntLenx + ix * 4);
            }
         }
   ...
   public static Match getMatch(MemorySegment mem, int offset) {
      return Match.fromValue(mem.get(PacketIO.PROTO_BYTE, (long)(offset + 19)));
   }
   ...
   public static InteractionTarget getEntityTarget(MemorySegment mem, int offset) {
      return InteractionTarget.fromValue(mem.get(PacketIO.PROTO_BYTE, (long)(offset + 20)));
   }
   ...
   public static EffectConditionInteraction toObject(MemorySegment mem, int offset) {
      if (offset + 45 > mem.byteSize()) {
         ...
         int[] tags = null;
         if (hasTags(mem, offset)) {
            int offx = offset + getValidatedOffset(mem, offset, 33, 45, "Tags");
         ...
         if (hasEntityEffects(mem, offset)) {
            int offxx = offset + getValidatedOffset(mem, offset, 41, 45, "EntityEffects");
            long packedxx = VarInt.getWithLength(mem, offxx);
            int lenxx = (int)packedxx;
            if (lenxx < 0) {
               throw ProtocolException.negativeLength("EntityEffects", lenxx);
            }

            if (lenxx > 4096000) {
               throw ProtocolException.arrayTooLong("EntityEffects", lenxx, 4096000);
            }

            int lenOffset = (int)(packedxx >>> 32);
            if (offxx + lenOffset + lenxx * 4L > mem.byteSize()) {
               throw ProtocolException.bufferTooSmall("EntityEffects", offxx + lenOffset + lenxx * 4, (int)mem.byteSize());
            }

            offxx += lenOffset;
            entityEffects = new int[lenxx];
            MemorySegment.copy(mem, PacketIO.PROTO_INT, offxx, entityEffects, 0, lenxx);
         }
         ...
         return new EffectConditionInteraction(
            ...
            entityEffects,
            Match.fromValue(mem.get(PacketIO.PROTO_BYTE, (long)(offset + 19))),
            InteractionTarget.fromValue(mem.get(PacketIO.PROTO_BYTE, (long)(offset + 20)))
         );
      }
   }
   ...
   public int serialize(@Nonnull MemorySegment mem, int offset) {
      ...
      mem.set(PacketIO.PROTO_BYTE, (long)(offset + 19), (byte)this.match.getValue());
      mem.set(PacketIO.PROTO_BYTE, (long)(offset + 20), (byte)this.entityTarget.getValue());
      int varOffset = offset + 45;
      if (this.effects != null) {
         mem.set(PacketIO.PROTO_INT, (long)(offset + 21), varOffset - offset - 45);
      ...
      if (this.settings != null) {
         mem.set(PacketIO.PROTO_INT, (long)(offset + 25), varOffset - offset - 45);
         if (this.settings.size() > 4096000) {
            throw ProtocolException.dictionaryTooLarge("Settings", this.settings.size(), 4096000);
         }
      ...
      if (this.rules != null) {
         mem.set(PacketIO.PROTO_INT, (long)(offset + 29), varOffset - offset - 45);
      ...
      if (this.tags != null) {
         mem.set(PacketIO.PROTO_INT, (long)(offset + 33), varOffset - offset - 45);
         if (this.tags.length > 4096000) {
            throw ProtocolException.arrayTooLong("Tags", this.tags.length, 4096000);
         }
      ...
      if (this.camera != null) {
         mem.set(PacketIO.PROTO_INT, (long)(offset + 37), varOffset - offset - 45);
      ...
      if (this.entityEffects != null) {
         mem.set(PacketIO.PROTO_INT, (long)(offset + 41), varOffset - offset - 45);
         if (this.entityEffects.length > 4096000) {
            throw ProtocolException.arrayTooLong("EntityEffects", this.entityEffects.length, 4096000);
         }
            ...
            if (v >= 2) {
               ...
               if (v >= 3) {
                  ...
                  if ((nullBits & 32) != 0) {
                     ...
                     int posxx = offset + 45 + v;
                     int entityEffectsCount = VarInt.peek(buffer, posxx);
                     if (entityEffectsCount < 0) {
                     ...
                     posxx += VarInt.size(entityEffectsCount);
                     posxx += entityEffectsCount * 4;
