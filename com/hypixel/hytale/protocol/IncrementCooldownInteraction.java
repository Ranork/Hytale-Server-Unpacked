...
public class IncrementCooldownInteraction extends SimpleInteraction {
   ...
   public static boolean getCooldownIncrementInterrupt(MemorySegment mem, int offset) {
      return mem.get(PacketIO.PROTO_BOOL, (long)(offset + 31));
   }
   ...
   public static IncrementCooldownInteraction toObject(MemorySegment mem, int offset) {
      if (offset + 56 > mem.byteSize()) {
         ...
         int[] tags = null;
         if (hasTags(mem, offset)) {
            int offx = offset + getValidatedOffset(mem, offset, 44, 56, "Tags");
         ...
         return new IncrementCooldownInteraction(
            ...
            mem.get(PacketIO.PROTO_BOOL, (long)(offset + 31))
         );
      }
   }
   ...
   public int serialize(@Nonnull MemorySegment mem, int offset) {
      ...
      mem.set(PacketIO.PROTO_FLOAT, (long)(offset + 19), this.cooldownIncrementTime);
      mem.set(PacketIO.PROTO_INT, (long)(offset + 23), this.cooldownIncrementCharge);
      mem.set(PacketIO.PROTO_FLOAT, (long)(offset + 27), this.cooldownIncrementChargeTime);
      mem.set(PacketIO.PROTO_BOOL, offset + 31, this.cooldownIncrementInterrupt);
      int varOffset = offset + 56;
      if (this.effects != null) {
         mem.set(PacketIO.PROTO_INT, (long)(offset + 32), varOffset - offset - 56);
      ...
      if (this.settings != null) {
         mem.set(PacketIO.PROTO_INT, (long)(offset + 36), varOffset - offset - 56);
         if (this.settings.size() > 4096000) {
            throw ProtocolException.dictionaryTooLarge("Settings", this.settings.size(), 4096000);
         }
      ...
      if (this.rules != null) {
         mem.set(PacketIO.PROTO_INT, (long)(offset + 40), varOffset - offset - 56);
      ...
      if (this.tags != null) {
         mem.set(PacketIO.PROTO_INT, (long)(offset + 44), varOffset - offset - 56);
         if (this.tags.length > 4096000) {
            throw ProtocolException.arrayTooLong("Tags", this.tags.length, 4096000);
         }
      ...
      if (this.camera != null) {
         mem.set(PacketIO.PROTO_INT, (long)(offset + 48), varOffset - offset - 56);
      ...
      if (this.cooldownId != null) {
         mem.set(PacketIO.PROTO_INT, (long)(offset + 52), varOffset - offset - 56);
      ...
      if (buffer.readableBytes() - offset < 56) {
         ...
         if (v >= 3) {
            ...
            if ((nullBits & 32) != 0) {
               ...
               int posxx = offset + 56 + v;
               int cooldownIdLen = VarInt.peek(buffer, posxx);
               if (cooldownIdLen < 0) {
               ...
               posxx += VarInt.size(cooldownIdLen);
               posxx += cooldownIdLen;
