...
public class RandomMusicContainer extends MusicContainer {
   ...
   public static RandomMode getMode(MemorySegment mem, int offset) {
      return RandomMode.fromValue(mem.get(PacketIO.PROTO_BYTE, (long)(offset + 63)));
   }
   ...
   public static int getAvoidRepeatCount(MemorySegment mem, int offset) {
      return mem.get(PacketIO.PROTO_INT, (long)(offset + 64));
   }
   ...
   public static RandomMusicContainer toObject(MemorySegment mem, int offset) {
      if (offset + 80 > mem.byteSize()) {
         ...
         return new RandomMusicContainer(
            ...
            stateBindings,
            RandomMode.fromValue(mem.get(PacketIO.PROTO_BYTE, (long)(offset + 63))),
            mem.get(PacketIO.PROTO_INT, (long)(offset + 64)),
            children
         );
      }
   }
   ...
   public int serialize(@Nonnull MemorySegment mem, int offset) {
      ...
      mem.set(PacketIO.PROTO_BYTE, (long)(offset + 63), (byte)this.mode.getValue());
      mem.set(PacketIO.PROTO_INT, (long)(offset + 64), this.avoidRepeatCount);
