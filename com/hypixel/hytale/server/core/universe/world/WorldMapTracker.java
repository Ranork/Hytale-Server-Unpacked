...
public class WorldMapTracker implements Tickable {
    ...
    public void updateCurrentZoneAndBiome(
        ...
        @Nullable ZoneDiscoveryInfo zoneDiscoveryInfo,
    ...
    private void onZoneDiscovered(
        @Nonnull Ref<EntityStore> ref, @Nonnull ZoneDiscoveryInfo zoneDiscoveryInfo, @Nonnull ComponentAccessor<EntityStore> componentAccessor
    ) {
        ZoneDiscoveryInfo discoverZoneEventInfo = zoneDiscoveryInfo.clone();
        Display discoverZoneEvent = new Display(discoverZoneEventInfo);
            ...
            if (!this.pendingReloadChunks.isEmpty()) {
                ...
                while (iterator.hasNext()) {
                    ...
                    if (future.isDone()) {
                        ...
                        int mapChunkX = ChunkUtil.xOfChunkIndex(chunkCoordinates);
                        int mapChunkZ = ChunkUtil.zOfChunkIndex(chunkCoordinates);
                        chunksToSend.add(new MapChunk(mapChunkX, mapChunkZ, (MapImage)future.getNow(null)));
            ...
            while (maxGeneration > 0 && this.spiralIterator.hasNext()) {
                ...
                if (!this.loaded.contains(chunkCoordinates)) {
                    ...
                    if (!future.isDone()) {
                        ...
                        int mapChunkX = ChunkUtil.xOfChunkIndex(chunkCoordinates);
                        int mapChunkZ = ChunkUtil.zOfChunkIndex(chunkCoordinates);
                        currentLoadList.add(new MapChunk(mapChunkX, mapChunkZ, (MapImage)future.getNow(null)));
                        packetSize -= fullMapChunkSize;
                        if (packetSize < fullMapChunkSize) {
                            packetSize = 2621427;
