...
public class ClearEntityEffectInteraction extends SimpleInteraction {
   ...
   public static InteractionTarget getEntityTarget(MemorySegment mem, int offset) {
      return InteractionTarget.fromValue(mem.get(PacketIO.PROTO_BYTE, (long)(offset + 23)));
   }
   ...
   public static ClearEntityEffectInteraction toObject(MemorySegment mem, int offset) {
      if (offset + 44 > mem.byteSize()) {
         ...
         int[] tags = null;
         if (hasTags(mem, offset)) {
            int offx = offset + getValidatedOffset(mem, offset, 36, 44, "Tags");
         ...
         return new ClearEntityEffectInteraction(
            ...
            InteractionTarget.fromValue(mem.get(PacketIO.PROTO_BYTE, (long)(offset + 23)))
         );
      }
   }
   ...
   public int serialize(@Nonnull MemorySegment mem, int offset) {
      ...
      mem.set(PacketIO.PROTO_INT, (long)(offset + 19), this.effectId);
      mem.set(PacketIO.PROTO_BYTE, (long)(offset + 23), (byte)this.entityTarget.getValue());
