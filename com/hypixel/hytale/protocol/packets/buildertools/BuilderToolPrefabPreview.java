...
public class BuilderToolPrefabPreview implements Packet, ToClientPacket {
   ...
   public static Integer getTilt(MemorySegment mem, int offset) {
      return hasTilt(mem, offset) ? mem.get(PacketIO.PROTO_INT, (long)(offset + 1)) : null;
   }
   ...
   public static Integer getSpinSpeed(MemorySegment mem, int offset) {
      return hasSpinSpeed(mem, offset) ? mem.get(PacketIO.PROTO_INT, (long)(offset + 5)) : null;
   }
   ...
   public static Integer getPreviewScale(MemorySegment mem, int offset) {
      return hasPreviewScale(mem, offset) ? mem.get(PacketIO.PROTO_INT, (long)(offset + 9)) : null;
   }
   ...
   public static Integer getBiomeTint(MemorySegment mem, int offset) {
      return hasBiomeTint(mem, offset) ? mem.get(PacketIO.PROTO_INT, (long)(offset + 13)) : null;
   }
   ...
   public static Integer getWaterTint(MemorySegment mem, int offset) {
      return hasWaterTint(mem, offset) ? mem.get(PacketIO.PROTO_INT, (long)(offset + 17)) : null;
   }
   ...
   public static BuilderToolPrefabPreview toObject(MemorySegment mem, int offset) {
      if (offset + 33 > mem.byteSize()) {
         ...
         if (hasFluidsChange(mem, offset)) {
            int offx = offset + getValidatedOffset(mem, offset, 25, 33, "FluidsChange");
         ...
         if (hasEntityChanges(mem, offset)) {
            int offxx = offset + getValidatedOffset(mem, offset, 29, 33, "EntityChanges");
         ...
         return new BuilderToolPrefabPreview(
            ...
            fluidsChange,
            entityChanges,
            hasTilt(mem, offset) ? mem.get(PacketIO.PROTO_INT, (long)(offset + 1)) : null,
            hasSpinSpeed(mem, offset) ? mem.get(PacketIO.PROTO_INT, (long)(offset + 5)) : null,
            hasPreviewScale(mem, offset) ? mem.get(PacketIO.PROTO_INT, (long)(offset + 9)) : null,
            hasBiomeTint(mem, offset) ? mem.get(PacketIO.PROTO_INT, (long)(offset + 13)) : null,
            hasWaterTint(mem, offset) ? mem.get(PacketIO.PROTO_INT, (long)(offset + 17)) : null
         );
      }
   }
   ...
   public int serialize(@Nonnull MemorySegment mem, int offset) {
      ...
      if (this.tilt != null) {
         mem.set(PacketIO.PROTO_INT, (long)(offset + 1), this.tilt);
      } else {
         mem.asSlice(offset + 1, 4L).fill((byte)0);
      }

      if (this.spinSpeed != null) {
         mem.set(PacketIO.PROTO_INT, (long)(offset + 5), this.spinSpeed);
      } else {
         mem.asSlice(offset + 5, 4L).fill((byte)0);
      }

      if (this.previewScale != null) {
         mem.set(PacketIO.PROTO_INT, (long)(offset + 9), this.previewScale);
      } else {
         mem.asSlice(offset + 9, 4L).fill((byte)0);
      }

      if (this.biomeTint != null) {
         mem.set(PacketIO.PROTO_INT, (long)(offset + 13), this.biomeTint);
      } else {
         mem.asSlice(offset + 13, 4L).fill((byte)0);
      }

      if (this.waterTint != null) {
         mem.set(PacketIO.PROTO_INT, (long)(offset + 17), this.waterTint);
      } else {
   ...
   public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
      if (buffer.readableBytes() - offset < 33) {
         ...
         if ((nullBits & 64) != 0) {
            ...
            int posx = offset + 33 + fluidsChangeOffset;
         ...
         if ((nullBits & 128) != 0) {
            ...
            int posxx = offset + 33 + entityChangesOffset;
