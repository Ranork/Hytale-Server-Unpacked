...
public class RunRootInteraction extends SimpleInteraction {
   ...
   public static RunRootInteraction toObject(MemorySegment mem, int offset) {
      if (offset + 43 > mem.byteSize()) {
         ...
         int[] tags = null;
         if (hasTags(mem, offset)) {
            int offx = offset + getValidatedOffset(mem, offset, 35, 43, "Tags");
   ...
   public int serialize(@Nonnull MemorySegment mem, int offset) {
      ...
      mem.set(PacketIO.PROTO_INT, (long)(offset + 19), this.rootInteraction);
      int varOffset = offset + 43;
      if (this.effects != null) {
         mem.set(PacketIO.PROTO_INT, (long)(offset + 23), varOffset - offset - 43);
      ...
      if (this.settings != null) {
         mem.set(PacketIO.PROTO_INT, (long)(offset + 27), varOffset - offset - 43);
         if (this.settings.size() > 4096000) {
            throw ProtocolException.dictionaryTooLarge("Settings", this.settings.size(), 4096000);
         }
      ...
      if (this.rules != null) {
         mem.set(PacketIO.PROTO_INT, (long)(offset + 31), varOffset - offset - 43);
      ...
      if (this.tags != null) {
         mem.set(PacketIO.PROTO_INT, (long)(offset + 35), varOffset - offset - 43);
         if (this.tags.length > 4096000) {
            throw ProtocolException.arrayTooLong("Tags", this.tags.length, 4096000);
         }
      ...
      if (this.camera != null) {
         mem.set(PacketIO.PROTO_INT, (long)(offset + 39), varOffset - offset - 43);
