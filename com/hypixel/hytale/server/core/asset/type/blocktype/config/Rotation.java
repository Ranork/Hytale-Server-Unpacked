...
import com.hypixel.hytale.server.core.asset.type.blocktype.config.Rotation.1;
...
public enum Rotation implements NetworkSerializable<com.hypixel.hytale.protocol.Rotation> {
    ...
    private Rotation(int param3, com.hypixel.hytale.protocol.Rotation param4, Axis param5, Vector3i param6) {
    ...
    public static Rotation valueOf(@Nonnull com.hypixel.hytale.protocol.Rotation packet) {
        return switch (1.$SwitchMap$com$hypixel$hytale$protocol$Rotation[packet.ordinal()]) {
            case 1 -> None;
            case 2 -> Ninety;
            case 3 -> OneEighty;
            case 4 -> TwoSeventy;
