...
public class ConditionInteraction extends SimpleInteraction {
   ...
   public static Boolean getJumping(MemorySegment mem, int offset) {
      return hasJumping(mem, offset) ? mem.get(PacketIO.PROTO_BOOL, (long)(offset + 21)) : null;
   }
   ...
   public static Boolean getSwimming(MemorySegment mem, int offset) {
      return hasSwimming(mem, offset) ? mem.get(PacketIO.PROTO_BOOL, (long)(offset + 22)) : null;
   }
   ...
   public static Boolean getCrouching(MemorySegment mem, int offset) {
      return hasCrouching(mem, offset) ? mem.get(PacketIO.PROTO_BOOL, (long)(offset + 23)) : null;
   }
   ...
   public static Boolean getRunning(MemorySegment mem, int offset) {
      return hasRunning(mem, offset) ? mem.get(PacketIO.PROTO_BOOL, (long)(offset + 24)) : null;
   }
   ...
   public static Boolean getFlying(MemorySegment mem, int offset) {
      return hasFlying(mem, offset) ? mem.get(PacketIO.PROTO_BOOL, (long)(offset + 25)) : null;
   }
   ...
   public static ConditionInteraction toObject(MemorySegment mem, int offset) {
      if (offset + 46 > mem.byteSize()) {
         ...
         return new ConditionInteraction(
            ...
            hasJumping(mem, offset) ? mem.get(PacketIO.PROTO_BOOL, (long)(offset + 21)) : null,
            hasSwimming(mem, offset) ? mem.get(PacketIO.PROTO_BOOL, (long)(offset + 22)) : null,
            hasCrouching(mem, offset) ? mem.get(PacketIO.PROTO_BOOL, (long)(offset + 23)) : null,
            hasRunning(mem, offset) ? mem.get(PacketIO.PROTO_BOOL, (long)(offset + 24)) : null,
            hasFlying(mem, offset) ? mem.get(PacketIO.PROTO_BOOL, (long)(offset + 25)) : null
         );
      }
   }
